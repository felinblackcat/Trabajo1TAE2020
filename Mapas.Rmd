...
# Variable categorica
barriosShape$categorica <- case_when(barriosShape$numerica == 0 ~ "peligro moderado", barriosShape$numerica == 1 ~ "peligro bajo", barriosShape$numerica == 2 ~ "peligro alto", barriosShape$numerica == 3 ~ "no agrupado")
```
```{r}
library('BBmisc')
...
###POP up
```{r}
popup <- paste0("<b>", "Nombre del barrio: ", "</b>", as.character(barriosShape$NOMBRE), 
